...
import br.app.servico.infra.mdotla.regras.RegrasMetadado;
...
public class MetadadoMock {
	...
	public static MetaDado criarMetadadoLogin() {
		...
		Componente entrada = new Componente("entradadados", "http://url.projeto/componentes", propriedadesEntradaDados);
		...
		Componente entradaSenha = new Componente("entradadados", "http://url.projeto/componentes",
				propriedadesEntradaDadosSenha);
		...
		Componente botao = new Componente("botao", "http://url.projeto/componentes", propriedadesBotao);
	...
	public static MetaDado criarMetadadoTelaPrincipal() {
		...
		Componente menu = new Componente("menu", "http://url.projeto/componentes", propriedadeMenu);
	...
	public static MetaDado criarMetadadoTelaIncialPagamentoTitulo() {
		...
		Componente entrada = new Componente("codigoBarras", "http://url.projeto/componentes", propriedadesEntradaDados);
	...
	public static MetaDado criarMetadadoTelaConfirmacaoPagamentoTitulo() {
		...
		Propriedade e4 = new Propriedade("idBeanObjetoPainelLabelDuplo",
				"#{componenteMB.bean['idPainelConfirmacaoPagamentoTitulo']}");

		propriedadePainel.add(e3);
		propriedadePainel.add(e4);

		Componente painelConfirmacao = new Componente("painelLabelDuplo", "http://url.projeto/componentes",
				propriedadePainel);

		Componente titulo = new Componente("titulo", "http://url.projeto/componentes", propriedadetitulo);
		...
		Componente botaoConfirmar = new Componente("botao", "http://url.projeto/componentes", propriedadesBotao);
		...
		Componente botaoCancelar = new Componente("botao", "http://url.projeto/componentes", propriedadesBotaoCancelar);
	...
	public static MetaDado criarMetadadoTelaComprovantePagamentoTitulo() {
		...
		Propriedade e4 = new Propriedade("idBeanObjetoPainelLabelDuplo",
				"#{componenteMB.bean['idPainelComprovantePagamentoTitulo']}");
	...
	public static void main(String args[]) {
		...
		regrasMetadado.converterMetadado(criarMetadadoLogin());
	}
}
